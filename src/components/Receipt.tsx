    ...
    <div style={{ 
      ...
      <div ref={receiptRef} style={{ padding: 24 }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: 24 }}>
          ...
          {data.school_address && (
            <p style={{ fontSize: 12, color: 'var(--t3)' }}>{data.school_address}</p>
          )}
          {data.school_phone && (
            <p style={{ fontSize: 12, color: 'var(--t3)' }}>{data.school_phone}</p>
          )}
        </div>
        ...
        <div style={{ 
          ...
          <p style={{ fontSize: 14, fontWeight: 700, color: 'var(--t1)', letterSpacing: 2 }}>
            FEE PAYMENT RECEIPT
          </p>
        </div>
        ...
        <div style={{ marginBottom: 20 }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
            <span style={{ color: 'var(--t3)', fontSize: 13 }}>Receipt No:</span>
            <span style={{ fontWeight: 600, fontSize: 13 }}>{data.receipt_number}</span>
          </div>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
            <span style={{ color: 'var(--t3)', fontSize: 13 }}>Date:</span>
            <span style={{ fontWeight: 600, fontSize: 13 }}>{data.payment_date}</span>
          </div>
        </div>
        ...
        <div style={{ 
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6 }}>
            ...
            <span style={{ fontWeight: 600, fontSize: 13 }}>{data.student_name}</span>
          </div>
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 6 }}>
            <span style={{ color: 'var(--t3)', fontSize: 13 }}>Number:</span>
            <span style={{ fontWeight: 600, fontSize: 13 }}>{data.student_number}</span>
          </div>
          <div style={{ display: 'flex', justifyContent: 'space-between' }}>
            <span style={{ color: 'var(--t3)', fontSize: 13 }}>Class:</span>
            <span style={{ fontWeight: 600, fontSize: 13 }}>{data.class_name}</span>
          </div>
        </div>
        ...
        <div style={{ 
          ...
          <p style={{ fontSize: 12, color: 'var(--t3)', marginBottom: 4 }}>Amount Paid</p>
        ...
        <div style={{ marginBottom: 20 }}>
          {data.fee_name && (
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
              ...
              <span style={{ fontWeight: 600, fontSize: 13 }}>{data.fee_name}</span>
            </div>
          )}
          <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: 8 }}>
            <span style={{ color: 'var(--t3)', fontSize: 13 }}>Payment Method:</span>
            <span style={{ fontWeight: 600, fontSize: 13 }}>{data.payment_method}</span>
          </div>
