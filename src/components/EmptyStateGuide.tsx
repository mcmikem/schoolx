...
const MODULE_GUIDES = {
  ...
  staff: {
    ...
    description:
      'Add teachers and staff to get started. You can add them one by one or import from a spreadsheet.',
    action: { label: 'Add Staff', href: '/dashboard/staff' },
  },
  classes: {
    title: 'No classes created',
    description:
      'Classes are the foundation of your school structure. Create classes like Primary 1, Senior 2, etc.',
    action: { label: 'Create Classes', href: '/dashboard/classes' },
  },
  subjects: {
    title: 'No subjects configured',
    description:
      'Add the subjects your school offers. Uganda-standard subjects are pre-loaded and ready to enable.',
  ...
  attendance: {
    ...
    description:
      'Start taking attendance for your classes. You can mark students as present, absent, or late.',
    action: { label: 'Take Attendance', href: '/dashboard/attendance' },
  },
  grades: {
    title: 'No grades entered',
    description:
      'Enter exam scores and continuous assessment marks for your students.',
    action: { label: 'Enter Grades', href: '/dashboard/grades' },
  },
  timetable: {
    title: 'No timetable created',
    description:
      'Create a class timetable to organize lessons, teachers, and periods.',
    action: { label: 'Create Timetable', href: '/dashboard/timetable' },
  },
  library: {
    title: 'Library is empty',
    description:
      'Add books to your library catalog. You can enter details manually or import a list.',
    action: { label: 'Add Books', href: '/dashboard/library' },
  },
  transport: {
    title: 'No transport routes',
    description:
      'Set up bus routes and assign students. Parents will be able to see route information.',
    action: { label: 'Setup Transport', href: '/dashboard/transport' },
  },
  canteen: {
    title: 'Canteen is empty',
    description:
      'Add items to your school canteen with prices. Students can order and pay using their wallets.',
    action: { label: 'Add Items', href: '/dashboard/canteen' },
  },
  expenses: {
    title: 'No expenses recorded',
    description:
      'Record school expenses to track spending. You can categorize them and attach receipts.',
    action: { label: 'Record Expense', href: '/dashboard/budget' },
  },
  notices: {
    title: 'No notices posted',
    description:
      'Post announcements and notices for parents and staff to see.',
    action: { label: 'Create Notice', href: '/dashboard/notices' },
  },
  homework: {
    title: 'No homework assigned',
    description:
      'Create homework assignments for your classes with instructions and due dates.',
...
export default function EmptyStateGuide({
  ...
  const resolvedDescription =
    guide?.description ?? description ?? 'There is nothing here yet.'
  ...
  return (
    ...
    >
      ...
      <h3 className="text-xl font-heading text-[var(--t1)] mb-3 tracking-tight">
        {resolvedTitle}
      </h3>
      <p className="text-[13px] text-[var(--t3)] font-medium max-w-sm mb-6 leading-relaxed">
        {resolvedDescription}
      </p>
      {resolvedAction && (
        <Link
