          ...
          <div style={{ textAlign: "center" }}>
            ...
            >
              <span
                ...
                style={{ fontSize: 40, color: "var(--navy)" }}
              >
                {steps[0].icon}
              </span>
            </div>
        ...
        {currentStep === 1 && (
          <div>
            ...
            >
              {defaultClasses.map((cls) => (
                <button
                  ...
                  style={{
                    padding: "12px 8px",
                    background: selectedClasses.includes(cls.name)
                      ? "var(--navy)"
                      : "var(--bg)",
            ...
            <p style={{ fontSize: 12, color: "var(--t3)", marginBottom: 24 }}>
              {tWithParams("wizard.selectedClasses", {
                count: selectedClasses.length.toString(),
              })}
            </p>
            ...
            <div style={{ display: "flex", gap: 12 }}>
              ...
              >
                {loading
                  ? t("wizard.creating")
                  : tWithParams("wizard.createClasses", {
                      count: selectedClasses.length.toString(),
                    })}
              </button>
            </div>
        ...
        {currentStep === 2 && (
          <div style={{ textAlign: "center" }}>
            ...
            <p style={{ fontSize: 14, color: "var(--t2)", marginBottom: 24 }}>
              Your classes have been created. You&apos;re ready to start
            ...
            >
              ...
              >
                <li>{t("wizard.addStudents")}</li>
                <li>{t("wizard.takeAttendance")}</li>
                <li>{t("wizard.recordPayments")}</li>
                <li>{t("wizard.enterGrades")}</li>
              </ul>
            </div>
