...
const WHATSAPP_MESSAGE = 'Hi, I need help with ASSEMBLE.'
        ...
        >
          ...
          <div className="bg-[#25D366] px-4 py-3 flex items-center gap-3">
            <div className="w-9 h-9 bg-white/20 rounded-full flex items-center justify-center flex-shrink-0">
              <MaterialIcon className="text-white text-base">support_agent</MaterialIcon>
            </div>
            ...
            <div className="space-y-2">
              ...
              >
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <path d="M12 2C6.477 2 2 6.477 2 12c0 1.89.525 3.66 1.438 5.168L2 22l4.832-1.438A9.955 9.955 0 0012 22c5.523 0 10-4.477 10-10S17.523 2 12 2z" fill="none" stroke="currentColor" strokeWidth="0"/>
                </svg>
                Chat on WhatsApp
              </a>
              <a
                href="mailto:support@omuto.org?subject=ASSEMBLE Support Request"
