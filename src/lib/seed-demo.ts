...
export async function seedDemoData() {
  ...
  try {
    ...
    // 2. Add Classes
    const classes = [
      { school_id: DEMO_SCHOOL_ID, name: 'P.1 Blue', level: 'P.1', academic_year: '2026' },
      { school_id: DEMO_SCHOOL_ID, name: 'P.2 Red', level: 'P.2', academic_year: '2026' },
      { school_id: DEMO_SCHOOL_ID, name: 'P.3 Green', level: 'P.3', academic_year: '2026' },
      { school_id: DEMO_SCHOOL_ID, name: 'P.7 candidates', level: 'P.7', academic_year: '2026' },
    ]
    ...
    // 4. Add Fee Structure
    const feeStructure = [
      { school_id: DEMO_SCHOOL_ID, name: 'Tuition Fee', amount: 450000, term: 1, academic_year: '2026' },
    ...
    const { error: feeError } = await supabase
      .from('fee_structure')
      .upsert(feeStructure, { onConflict: 'school_id,name,term,academic_year' })
