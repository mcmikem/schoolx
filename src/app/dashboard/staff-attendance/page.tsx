...
export default function StaffAttendancePage() {
  ...
  const statusOptions = [
    { status: 'present', label: 'Present', color: 'bg-[#ecfdf5] text-[#006e1c] border-[#006e1c]', active: false },
    { status: 'absent', label: 'Absent', color: 'bg-[#fef2f2] text-[#ba1a1a] border-[#ba1a1a]', active: false },
    { status: 'late', label: 'Late', color: 'bg-[#fff7ed] text-[#b86e00] border-[#b86e00]', active: false },
    { status: 'leave', label: 'Leave', color: 'bg-[#e3f2fd] text-[#002045] border-[#002045]', active: false },
  ]
