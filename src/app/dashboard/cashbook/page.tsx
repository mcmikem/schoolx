              ...
              {filteredPayments.length === 0 ? (
                ...
                filteredPayments.map((payment) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-right text-[var(--green)] font-medium">
