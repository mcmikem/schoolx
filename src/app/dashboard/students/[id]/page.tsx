  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-3 mb-6">
        <Link href="/dashboard/students" className="p-2 hover:bg-gray-100 rounded-lg">
          ...
          <div className="flex flex-col md:flex-row md:items-end gap-4 -mt-12">
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap items-center gap-4 mt-2 text-sm text-gray-500">
                ...
                <span className="flex items-center gap-1">
                  <GraduationCap className="w-4 h-4" /> {student.classes?.name || 'N/A'}
                </span>
                <span className="flex items-center gap-1 uppercase tracking-widest font-black text-[10px]">
                  <Droplets className="w-4 h-4" /> Blood: {student.blood_type || 'N/A'}
                </span>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm font-medium text-gray-900">{student.parent_phone || 'N/A'}</div>
                </div>
              </div>
              {student.parent_phone2 && (
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm font-medium text-gray-900">{student.parent_phone2}</div>
                  </div>
                </div>
              )}
              {student.parent_email && (
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm font-medium text-gray-900">{student.parent_email}</div>
                  </div>
                </div>
              )}
              {student.address && (
