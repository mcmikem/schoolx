...
import { useDashboardStats, useStudents } from '@/lib/hooks'
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              {statsLoading ? (
                ...
                <div className="stat-value">{formatCurrency(stats.feesCollected)}</div>
              )}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              {statsLoading ? (
                ...
                <div className="stat-value">{formatCurrency(stats.feesBalance)}</div>
              )}
          ...
          {[
            ...
            >
              <div className={`w-10 h-10 bg-${action.color}-50 rounded-lg flex items-center justify-center`}>
                <svg className={`w-5 h-5 text-${action.color}-600`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="card">
          <h2 className="text-lg font-semibold text-gray-900 mb-4">Student Summary</h2>
          {studentsLoading ? (
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="font-semibold text-gray-900">{boysCount}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-gray-600">Girls</span>
                <span className="font-semibold text-gray-900">{girlsCount}</span>
              </div>
              {students.length > 0 && (
                <div className="mt-4">
        ...
        <div className="card">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="font-semibold text-gray-900">Term {currentTerm}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-gray-600">School Code</span>
              <span className="font-semibold text-gray-900">{school?.school_code || 'N/A'}</span>
            </div>
            <div className="flex items-center justify-between">
              <span className="text-gray-600">District</span>
              <span className="font-semibold text-gray-900">{school?.district || 'N/A'}</span>
            </div>
          </div>
        </div>
      </div>
