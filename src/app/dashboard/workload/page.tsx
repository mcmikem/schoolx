...
export default function WorkloadPage() {
  ...
  const getRatingStyle = (rating: TeacherWorkload["rating"]) => {
    switch (rating) {
      case "Light":
        return { bg: "bg-[var(--green-soft)]", text: "text-[var(--green)]", bar: "bg-green-500" };
      case "Normal":
        return { bg: "bg-[#fff8e1]", text: "text-[#b8860b]", bar: "bg-yellow-500" };
      case "Heavy":
        return { bg: "bg-[var(--amber-soft)]", text: "text-[#b86e00]", bar: "bg-orange-500" };
      case "Overloaded":
        return { bg: "bg-[#fef2f2]", text: "text-[#ba1a1a]", bar: "bg-red-500" };
    }
  };
                ...
                <table className="w-full">
                  <thead>
                    <tr className="bg-[var(--surface-container-low)]">
                      ...
                      <th className="p-4 text-left text-sm font-semibold text-[var(--t1)] hidden md:table-cell">
                        Classes
                      </th>
                      <th className="p-4 text-left text-sm font-semibold text-[var(--t1)] hidden lg:table-cell">
                        Subjects
                      </th>
