...
export default function AuditLogPage() {
  ...
  const isHighRisk = (log: AuditEntry) => {
    ...
    if (["fees", "grades", "automation", "settings"].includes(log.module))
      return true;
    return /publish|lock|unlock|write-off|write off|bursary|delete|approve/i.test(
      log.description,
    );
  };
      ...
      <Card className="max-w-2xl">
        <CardBody>
          ...
          <ul className="space-y-2 text-sm text-[var(--t3)]">
            ...
            <li>
              Activities include: creating, updating, deleting, and viewing
              records
            </li>
