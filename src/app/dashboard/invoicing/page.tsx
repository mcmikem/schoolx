...
export default function InvoicingPage() {
          ...
          <div class="invoice">
            ...
            <div class="info">
              <div class="info-row">
                ...
                <span>${escapeHtml(invoice.student_name)}</span>
              </div>
              <div class="info-row">
                <span class="info-label">Student Number:</span>
                <span>${escapeHtml(invoice.student_number)}</span>
              </div>
              <div class="info-row">
                <span class="info-label">Class:</span>
                <span>${escapeHtml(invoice.class_name)}</span>
              </div>
              <div class="info-row">
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      <PageHeader
        title="Fee Invoicing"
        subtitle="Generate and manage student invoices"
      />
            ...
            <tbody>
              {filteredInvoices.map((invoice) => (
                <tr key={invoice.student_id}>
                  ...
                  <td>
                    <span
                      className={`px-2.5 py-1 rounded-full text-xs font-medium ${invoice.balance === 0 ? "bg-[#e8f5e9] text-[#006e1c]" : "bg-[#fff3e0] text-[#e65100]"}`}
                    >
