          ...
          <Card className="p-6">
            ...
            <div>
              ...
              <div className="flex items-center justify-between mt-2">
                <p
                  className={`text-xs ${message.length > 160 ? "text-red-600 font-medium" : "text-[var(--t3)]"}`}
                >
          ...
          <Card className="p-4 bg-[var(--surface-container)]">
            <p className="text-sm text-[var(--t3)]">
              ...
              {smsCount > 0 && (
                <span>
                  {" "}
                  ({recipients.phoneCount * smsCount} total SMS segment
                  {recipients.phoneCount * smsCount > 1 ? "s" : ""})
                </span>
              )}
            </p>
          </Card>
