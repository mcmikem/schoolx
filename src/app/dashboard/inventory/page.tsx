            ...
            lowStockItems.length > 0 && (
              <div className="flex items-center gap-3 px-4 py-2 bg-[var(--red-soft)] rounded-xl border border-[var(--red)]/20">
                ...
                <div>
                  ...
                  <p className="text-sm text-[var(--on-surface)] font-medium">
                      ...
                      <tr key={asset.id} className="hover:bg-[var(--surface-container)] transition-colors group">
                        <td className="py-4">
                          <div>
                            ...
                            {asset.is_consumable && (
                              <span className="text-[10px] px-1.5 py-0.5 rounded bg-[var(--navy-soft)] text-[var(--navy)] font-bold uppercase tracking-wider">
                                Consumable
                              </span>
                            )}
                          </div>
            ...
            {transactions.length === 0 ? (
              ...
              <div className="space-y-4">
                {transactions.slice(0, 8).map((tx) => (
                  <div
                    key={tx.id}
                    className="flex items-center gap-4 p-3 rounded-xl bg-[var(--surface-container)] border border-[var(--border)]"
                  >
                    <div
                      className={`p-2 rounded-lg ${tx.transaction_type === "in" ? "bg-[var(--green-soft)] text-[var(--green)]" : "bg-[var(--red-soft)] text-[var(--red)]"}`}
                    >
                      <MaterialIcon
                        icon={tx.transaction_type === "in" ? "arrow_downward" : "arrow_upward"}
                        className="text-sm"
                      />
                    </div>
