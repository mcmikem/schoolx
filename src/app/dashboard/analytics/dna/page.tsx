    ...
    <div className="p-4 sm:p-6 lg:p-8 max-w-7xl mx-auto space-y-8 animate-in fade-in duration-700">
      <div className="flex justify-between items-end">
        <div>
           <div className="flex items-center gap-3 mb-1">
              ...
              <h1 className="text-3xl font-black text-slate-800 tracking-tight">Performance DNA</h1>
           </div>
           <p className="text-slate-500 font-medium tracking-tight">Holistic student correlation and character-academic mapping</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
           <div className={cardClassName + " p-8 flex flex-col items-center justify-center min-h-[450px]"}>
              <h3 className="text-sm font-black text-slate-400 uppercase tracking-widest mb-8 text-center">Biometric Success Matrix</h3>
              <ResponsiveContainer width="100%" height={350}>
                <RadarChart cx="50%" cy="50%" outerRadius="80%" data={mockDNAData}>
              ...
              <div className="grid grid-cols-3 gap-4 w-full mt-6">
                 <div className="text-center">
                    <p className="text-[9px] font-black text-slate-400 uppercase">IQ Index</p>
                    <p className="text-lg font-black text-slate-800">85/100</p>
                 </div>
                 <div className="text-center">
                    <p className="text-[9px] font-black text-slate-400 uppercase">EQ Index</p>
        ...
        <div className="lg:col-span-3 space-y-6">
           <div className={cardClassName + " p-6"}>
              <div className="flex justify-between items-center mb-8">
                <h3 className="text-sm font-black text-slate-400 uppercase tracking-widest">Welfare Correlation</h3>
                <div className="flex gap-4">
                   ...
                   <div className="flex items-center gap-2">
                      ...
                      <span className="text-[10px] font-bold text-slate-500">Conduct</span>
                   </div>
                </div>
              </div>
              <ResponsiveContainer width="100%" height={300}>
                <LineChart data={correlationData}>
                  ...
                  />
                  <Line type="monotone" dataKey="grades" stroke="#3b82f6" strokeWidth={4} dot={{ r: 4, strokeWidth: 2, fill: '#fff' }} activeDot={{ r: 6 }} />
                  <Line type="monotone" dataKey="conduct" stroke="#10b981" strokeWidth={4} strokeDasharray="8 5" dot={{ r: 4, strokeWidth: 2, fill: '#fff' }} />
                </LineChart>
              </ResponsiveContainer>
              <div className="mt-4 p-4 bg-slate-50 rounded-2xl border border-slate-100 italic text-[11px] text-slate-500 leading-relaxed">
                Analysis: This student shows a <strong>strong positive correlation</strong> (0.84) between conduct points and academic results. Improving classroom behavior likely precedes grade spikes.
              </div>
           </div>

           <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className={cardClassName + " p-6 bg-slate-900 border-none relative overflow-hidden"}>
                 <MaterialIcon icon="bolt" className="absolute -right-4 -top-4 text-white/10" style={{ fontSize: 90 }} />
                 <h4 className="text-[10px] font-black uppercase text-white/40 tracking-widest mb-2 relative z-10">AI Insight</h4>
                 <p className="text-xs text-white/80 leading-relaxed font-medium relative z-10">
                   Spending patterns peaked on Week 3 (UGX 45k) which coincided with a dip in grades. Possible correlation between canteen spending and study distraction.
                 </p>
              </div>
              
              <div className={cardClassName + " p-6 border-indigo-100 bg-indigo-50/30"}>
                 <h4 className="text-[10px] font-black uppercase text-indigo-400 tracking-widest mb-3">Holistic Wellness</h4>
                 <div className="space-y-3">
                    <div className="flex justify-between items-center">
                       <span className="text-xs font-bold text-slate-600">Social Integration</span>
                       <span className="text-xs font-black text-indigo-700">65%</span>
                    </div>
