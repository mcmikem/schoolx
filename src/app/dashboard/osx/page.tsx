        ...
        <PageHeader
          ...
          actions={
            <div className="flex items-center gap-3">
              ...
              <Button variant="secondary" size="sm" icon={<MaterialIcon icon="upgrade" />}>
                Upgrade Tier
              </Button>
            </div>
          }
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-8 max-w-4xl mx-auto">
              {STEPS.map((step, idx) => (
                <div key={step.id} className="relative flex flex-col items-center flex-1">
                  ...
                  <div className="text-[10px] font-extrabold uppercase tracking-widest text-[var(--primary-900)]/60 text-center">
                    {step.name}
                  </div>
                  {idx < STEPS.length - 1 && (
                    <div
                      className={`hidden md:block absolute top-6 left-[calc(50%+28px)] w-[calc(100%-56px)] h-0.5 ${step.status === "complete" ? "bg-green-500/30" : "bg-[var(--primary-900)]/10"}`}
                    />
                  )}
                </div>
              ))}
          ...
          <div className="space-y-6">
            ...
            <Card>
              <CardBody>
                ...
                <Button variant="primary" className="w-full mt-4 text-xs font-black uppercase tracking-widest py-3">
                  Request Rate Card
                </Button>
              </CardBody>
            </Card>
