      ...
      <div className="max-w-3xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 mb-6 shadow-sm">
          ...
          <div className="space-y-4 text-sm text-gray-700 dark:text-gray-300 leading-relaxed">
            ...
            <div>
              ...
              <p>Data is processed to: manage student records, track academic progress, collect fees, communicate with parents, comply with MoES/UNEB reporting requirements, and provide the SkoolMate service.</p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Data Retention</h3>
              <p>Student records are retained for the duration of enrollment plus 7 years (per UNEB requirements). Parent/guardian contact data is retained while the student is enrolled. You may request deletion at any time.</p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Third-Party Sharing</h3>
              <p>Data is shared only with: school administrators, UNEB (for exam registration), MoES (for statutory reports), and payment processors (for fee collection). We do not sell personal data.</p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Data Storage & Security</h3>
              <p>Data is stored on encrypted servers with role-based access control. All transmissions use TLS encryption. Backups are encrypted and access-logged.</p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Children&apos;s Data</h3>
              <p>Student data is processed under legitimate interest and contractual necessity. Schools must obtain informed consent from parents/guardians before entering student data. Students under 18 have additional protections under Section 10 of the PDPA.</p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Your Rights</h3>
              <p>Under the PDPA, you have the right to: access your data, correct inaccuracies, withdraw consent, request data portability, and request deletion. Use the tools below or contact your school administrator.</p>
            </div>
            <div>
              <h3 className="font-semibold text-gray-900 dark:text-gray-100 mb-1">Complaints</h3>
              <p>You may lodge a complaint with the National Information Technology Authority (NITA-U) or the Office of the Data Protection & Privacy Officer, PDPO, Kampala.</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 p-6 mb-6 shadow-sm">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
            Download a copy of all your personal data stored in SkoolMate, including profile, academic records, and financial history. This is your right under Section 19 of the PDPA.
          </p>
          <button
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl border border-red-200 dark:border-red-900/50 p-6 shadow-sm">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">
            Permanently delete your account and all associated data. <strong className="text-red-600 dark:text-red-400">This action cannot be undone.</strong> Under PDPA Section 21, you have the right to request erasure of your personal data.
          </p>
          {!showDeleteConfirm ? (
            <button
            ...
            <div className="bg-red-50 dark:bg-red-900/20 rounded-xl p-4">
              <p className="text-sm font-medium text-red-700 dark:text-red-300 mb-3">
                Are you absolutely sure? This will permanently delete your account, all your data, and cannot be reversed.
              </p>
