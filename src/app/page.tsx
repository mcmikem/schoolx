...
const plans = [
  ...
  },
  {
    ...
    cadence: "per term",
    description:
      "For schools that need stronger communication and deeper operational visibility.",
    features: [
      "Up to 1,000 students",
      "Auto SMS reports",
      "Parent portal",
      "Global search and Luganda support",
    ],
    featured: true,
  },
  {
    ...
    cadence: "per term",
    description:
      "For multi-campus or high-volume schools that want full SchoolX coverage.",
    features: [
      "Unlimited students",
      "Offline mode",
      "Custom reports",
