        ...
        <div className="relative bg-[var(--surface)] rounded-2xl shadow-2xl border border-[var(--border)] w-full max-w-md h-full max-h-[90vh] overflow-y-auto flex flex-col">
          ...
          <div className="flex-1 p-5 space-y-5">
            ...
            <div className="rounded-xl border border-red-200 bg-red-50 p-4">
              <div className="text-[12px] font-bold text-red-700 mb-2">Danger Zone</div>
              <p className="text-[11px] text-red-600 mb-3">Suspending blocks all access. Data is preserved and can be restored.</p>
...
export default function SuperAdminPage() {
  ...
  const saveSettings = async () => {
    ...
    try { await new Promise((r) => setTimeout(r, 500)); toast.success("Platform settings saved"); }
